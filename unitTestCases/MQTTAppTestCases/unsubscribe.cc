...
struct unsubscribeMqttTest : commandTest
{
	protected:

	virtual void SetUp()
	{
		std::cout << "IN UNSUBSCRIBE-MQTT SETUP" << std::endl;
	}
...
//PERFECT PACKAGE.
TEST_F(unsubscribeMqttTest, unsubscribeTopic)
{
	...
	EXPECT_EQ(0, mqttPtr->unregisterTopic(jsonobj1,appName));
...
TEST_F(unsubscribeMqttTest, NegativeTest1)
{
	...
	EXPECT_EQ(1, mqttPtr->unregisterTopic(jsonobj,appName));

}


//TOPIC IS NOT PRESENT IN THE PACKAGE.
TEST_F(unsubscribeMqttTest, NegativeTest2)
{
...
//TOPIC IS EMPTY
TEST_F(unsubscribeMqttTest, NegativeTest3)
{
...
//INVALID JSON
TEST_F(unsubscribeMqttTest, NegativeTest4)
{

Import('onb_env','nsobj','pobj', 'ajobj')
...
if onb_env['BUILD_SERVICES_SAMPLES'] == 'on':
    ...
    onb_env.Install(['$ALLJOYN_APP2_DISTDIR/bin','$PACKAGES/packages/App/bin'], onb_env.SConscript('Mqtt/SConscript', exports =['onb_env','nsobj','pobj', 'ajobj']))
